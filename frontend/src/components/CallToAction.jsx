...
const CallToAction = () => {
  return (
    <>
      <div className="flex flex-col sm:flex-row p-3 border border-teal-500 justify-center items-center rounded-xl ">
        <div className="flex-1 justify-center flex flex-col p-4 text-center">
          ...
          <Button className="rounded-xl max-w-md mx-7 mt-3">
            <a href="https://www.youtube.com/@freecodecamp/videos">Watch now</a>
          </Button>
        </div>
        <div className="p-7">
          <a
